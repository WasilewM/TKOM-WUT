...
public record IntListFunctionDef(Position position, String name, LinkedHashMap<String, IParameter> parameters,
                                 CodeBlock functionCode) implements IFunctionDef {

    public IntListFunctionDef(IntListParameter functionType, LinkedHashMap<String, IParameter> parameters, CodeBlock codeBlock) {
